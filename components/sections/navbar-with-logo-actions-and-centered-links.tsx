...
export function NavbarLink({
  ...
  return (
    <Link
      href={href}
      className={clsx(
        'group inline-flex items-center justify-between gap-2 text-3xl/10 font-medium text-mauve-950 lg:text-base/7 dark:text-white',
        className,
      )}
      {...props}
    >
      ...
      <nav>
        ...
        <ElDialog className="lg:hidden">
          <dialog id="mobile-menu" className="backdrop:bg-transparent">
            <ElDialogPanel className="fixed inset-0 bg-[#fcfcfc] px-6 py-6 lg:px-10 dark:bg-mauve-950">
